...
if($id){
	mysql_query("UPDATE factures SET id_client='$id_client',date='$date',numero='$numero',objet='$objet',montant='$montant',pourcent_tva='$pourcent_tva',montant_tva='$montant_tva',montant_tvac='$montant_tvac' WHERE id='$id'") or die(mysql_error());
}else{
...
header("location:../entrees.php?annee=".$lannee);
?>