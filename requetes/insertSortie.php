...
if($id){
	mysql_query("UPDATE depenses SET date='$date',objet='$objet',montant='$montant',pourcent_tva='$pourcent_tva',montant_tva='$montant_tva',montant_tvac='$montant_tvac',deductibilite='$deductibilite' WHERE id='$id'") or die(mysql_error());
}else{
...
header("location:../sorties.php?annee=".$lannee);
?>