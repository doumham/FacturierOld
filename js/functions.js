...
// 	new Ajax.Request('requetes/togglePaid.php?id='+id+'&annee='+annee+'&ordre='+ordre+'&paid='+paid,{
// 		onComplete: function() {
// 			if(paid==0){
...
// 			window.location="requetes/deleteEntrees.php?id="+element;
// 		}else{
// 			return false;
// 		}
// 	}
...
// 		window.location="requetes/deleteSorties.php?id="+element;
// 	}else{
// 		return false;
// 	}
// }
