...
if(isset($_GET['id']) && $_GET['id']){
	$id = $_GET['id'];
	$selectContrats = mysql_query("SELECT * FROM `contrats` WHERE `id`='$id'") or trigger_error(mysql_error(),E_USER_ERROR);
	$f = mysql_fetch_array($selectContrats);
	extract($f);
...
if (!isset($_GET['ajaxed'])) {
	$myInterface->set_title("Facturier – Contrat");
